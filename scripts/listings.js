document.addEventListener("DOMContentLoaded", function () {
  fetch("https://api.noroff.dev/api/v1/auction/listings")
    ...
    .then((objectData) => {
      ...
      document.getElementById("cardHeader").innerHTML = values.title;
      document.getElementById("cardDescription").innerHTML = values.description;
      document.getElementById("cardMedia").innerHTML = mediaHTML;
      document.getElementById("cardTags").innerHTML = values.tags;
      document.getElementById("cardCreated").innerHTML = values.created;
      document.getElementById("cardUpdated").innerHTML = values.updated;
